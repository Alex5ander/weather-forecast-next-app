async function getData(q) {
  try {
    ...
    const request = await fetch(url, { next: { revalidate: 100 } });
      ...
      <main className="flex flex-col gap-y-4 w-full">
        ...
        {/* {data && (
          <div className="text-white flex flex-col gap-y-4 items-center">
            ...
            <div className="flex gap-x-4 justify-between text-lg font-semibold">
              <div className="items-center gap-y-2 flex flex-col">
                ...
                <p className="text-center">Umidade do ar</p>
              </div>
              ...
              <div className="items-center gap-y-2 flex flex-col">
                ...
                <p className="text-center">Velocidade do vento</p>
              </div>
            </div>
          </div>
        )} */}
